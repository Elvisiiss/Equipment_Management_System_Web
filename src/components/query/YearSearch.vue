<template>
  <el-form :model="form" label-width="100px" inline>
    <el-form-item label="开始年份">
      <el-date-picker v-model="form.startYear" type="year" placeholder="选择开始年份" />
    </el-form-item>
    <el-form-item label="结束年份">
      <el-date-picker v-model="form.endYear" type="year" placeholder="选择结束年份" />
    </el-form-item>
    ...
    <el-form-item label="产线">
      <el-select v-model="form.productionLine" placeholder="请选择产线">
        <el-option label="产线A" value="A" />
        <el-option label="产线B" value="B" />
      </el-select>
    </el-form-item>
    <el-form-item label="工段">
      <el-select v-model="form.section" placeholder="请选择工段">
