<template>
  ...
  <div class="equipment-screen">
    ...
    <div class="status-cards">
      <div class="card" style="background-color: #4F52D7FF;">保养计划 68</div>
      <div class="card" style="background-color: #409EFF;">待执行 25</div>
      <div class="card" style="background-color: #E6A23C;">执行中 12</div>
      <div class="card" style="background-color: #67C23A;">已完成 28</div>
      <div class="card" style="background-color: #F56C6C;">逾期 3</div>
    </div>
    ...
    <el-row :gutter="16" class="chart-row">
      <el-col :span="12">
        <div class="chart-card">
          <div class="chart-header">
            <h3><i class="el-icon-pie-chart"></i> 保养类型分布</h3>
      ...
      <el-col :span="12">
        <div class="chart-card">
          <div class="chart-header">
            <h3><i class="el-icon-data-line"></i> 保养完成率</h3>
            <el-button type="text" @click="goManage">详情</el-button>
          </div>
          <div class="chart-container">
            <v-chart :option="ratePieOption" autoresize style="height: 100%;" />
          </div>
        </div>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="16" class="chart-row">
      <el-col :span="12">
        <div class="chart-card">
          <div class="chart-header">
            <h3><i class="el-icon-trend-charts"></i> 本周保养完成趋势</h3>
            <el-button type="text" @click="goManage">详情</el-button>
          </div>
          <div class="trend-data-display">
            <div v-for="(day, index) in lineOption.xAxis.data" :key="index" class="trend-item">
              ...
              <div class="trend-value">{{ lineOption.series[0].data[index] }}项</div>
            </div>
          </div>
          <div class="chart-container">
      ...
      <el-col :span="12">
        <div class="chart-card">
          <div class="chart-header">
            <h3><i class="el-icon-warning-outline"></i> 逾期任务</h3>
            <el-button type="text" @click="goManage">详情</el-button>
          </div>
          <div class="table-container">
            <el-table :data="overdueTasks" size="small" style="width: 100%; height: 100%;" @row-click="() => goManage()">
              <el-table-column type="index" width="50" align="center" />
              <el-table-column prop="name" label="设备名称" show-overflow-tooltip min-width="120" />
              <el-table-column prop="type" label="保养类型" width="100" align="center" />
              <el-table-column prop="dueDate" label="计划日期" width="120" align="center" />
...
const goManage = () => {
  router.push('/equipment/maintenance/manage')
}
...
watch(() => route.currentRoute.value.path, (newPath) => {
  if (newPath !== '/equipment/maintenance/screen') {
  ...
  series: [
    {
      ...
      data: [
        {value: 35, name: '日常保养', itemStyle: {color: '#67C23A'}},
        {value: 20, name: '一级保养', itemStyle: {color: '#E6A23C'}},
        {value: 10, name: '二级保养', itemStyle: {color: '#409EFF'}},
        {value: 3, name: '大修', itemStyle: {color: '#909399'}}
      ]
    }
  ]
})

const ratePieOption = ref({
  tooltip: {trigger: 'item'},
  legend: {
    orient: 'vertical',
    right: 10,
  ...
  series: [
    {
      ...
      data: [
        ...
        {value: 25, name: '待执行', itemStyle: {color: '#E6A23C'}},
        {value: 12, name: '执行中', itemStyle: {color: '#409EFF'}},
        {value: 3, name: '逾期', itemStyle: {color: '#F56C6C'}}
      ]
    }
  ]
})
...
const overdueTasks = ref([
  {name: 'C4-51-16', type: '一级保养', dueDate: '2025-07-15', overdueDays: 7},
  {name: 'C4-51-23', type: '日常保养', dueDate: '2025-07-18', overdueDays: 4},
  {name: 'C4-51-24', type: '二级保养', dueDate: '2025-07-20', overdueDays: 2},
  {name: 'C4-51-21', type: '日常保养', dueDate: '2025-07-21', overdueDays: 1},
  {name: 'C4-51-19', type: '一级保养', dueDate: '2025-07-21', overdueDays: 1},
  {name: 'C4-51-26', type: '日常保养', dueDate: '2025-07-22', overdueDays: 0},
  {name: 'C4-51-22', type: '日常保养', dueDate: '2025-07-22', overdueDays: 0},
  {name: 'C4-51-31', type: '大修', dueDate: '2025-07-22', overdueDays: 0}
])
